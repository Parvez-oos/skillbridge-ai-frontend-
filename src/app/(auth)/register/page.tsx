...
import { registerSchema, RegisterFormData } from '@/features/auth/validation';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0" style={{
        backgroundImage: 'radial-gradient(ellipse at 70% 30%, var(--accent) 0%, transparent 50%)',
        opacity: 0.05,
      }} />
      <div className="absolute top-1/3 left-1/4 w-[400px] h-[400px] bg-accent/5 rounded-full blur-[100px]" />
      <div className="absolute bottom-1/3 right-1/4 w-[300px] h-[300px] bg-primary/5 rounded-full blur-[80px]" />
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in-up">
        <div className="text-center mb-8">
          ...
          <span className="font-overline text-primary mb-2 block">Get Started</span>
          <h1 className="text-3xl font-heading tracking-tight text-foreground">Create your account</h1>
          <p className="text-muted-foreground mt-2 leading-relaxed">Start your learning journey today</p>
        </div>
        ...
        <div className="glass-strong rounded-2xl border border-border/50 p-8 shadow-2xl shadow-primary/5">
          ...
          <OAuthButtons mode="register" disabled={isLoading || demoLoading} />
